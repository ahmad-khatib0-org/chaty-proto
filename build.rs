fn main() -> Result<(), Box<dyn std::error::Error>> {
  ...
  tonic_build::configure()
    ...
    .type_attribute(
      "service.v1.EmbedWebsiteMetadataSpecial",
      "#[derive(scylla::SerializeValue, scylla::DeserializeValue)]",
    )
    .type_attribute(
      "service.v1.EmbedWebsiteMetadata",
      "#[derive(scylla::SerializeValue, scylla::DeserializeValue)]",
    )
    .type_attribute(
      "service.v1.Embed",
    ...
    .type_attribute(
      "service.v1.Interactions",
      "#[derive(scylla::SerializeValue, scylla::DeserializeValue)]",
    )
    .type_attribute(
      "service.v1.Masquerade",
      "#[derive(scylla::SerializeValue, scylla::DeserializeValue)]",
    )
    .type_attribute(
      "service.v1.Message",
    ...
    .type_attribute(
      ...
      "#[derive(scylla::SerializeValue, scylla::DeserializeValue, Eq, Hash)]",
    )
    .type_attribute(
