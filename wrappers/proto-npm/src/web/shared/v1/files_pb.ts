...
export const file_shared_v1_files: GenFile = /*@__PURE__*/
  fileDesc("");
...
export type FileMetadataText = Message<"shared.v1.FileMetadataText"> & {
  /**
   * @generated from field: int64 text_length = 1;
   */
  textLength: bigint;
};
